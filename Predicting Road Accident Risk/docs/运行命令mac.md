...
已创建完整的 Python 脚本：`road_accident_risk_mac.py`
...
```bash
python3 road_accident_risk_mac.py --data-dir ./playground-series-s5e10
```

### 3. 指定输出目录

```bash
python3 road_accident_risk_mac.py --output-dir ./my_output
```

### 4. 跳过依赖安装

```bash
python3 road_accident_risk_mac.py --skip-install
```
